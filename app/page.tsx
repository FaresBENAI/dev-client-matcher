...
export default function HomePage() {
 ...
 return (
   <div className="min-h-screen bg-slate-900">
     ...
     <div className="bg-slate-900 py-24">
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="grid md:grid-cols-3 gap-8 mb-12">
           {sampleProjects.length > 0 ? sampleProjects.map((project, index) => (
             ...
             <>
               <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
                 ...
                 <h3 className="text-xl font-semibold text-white mb-3">
                   Assistant IA pour e-commerce
                 </h3>
                 <p className="text-slate-300 mb-4">
                   Développer un chatbot intelligent pour améliorer l'expérience client et augmenter les conversions sur notre site e-commerce.
                 </p>
                 <div className="flex justify-between items-center mb-4">
               ...
               <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
                 ...
                 <h3 className="text-xl font-semibold text-white mb-3">
                   Automatisation workflow RH
                 </h3>
                 <p className="text-slate-300 mb-4">
                   Automatiser les processus de recrutement, de la réception des CV à la planification des entretiens.
                 </p>
                 <div className="flex justify-between items-center mb-4">
               ...
               <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
                 ...
                 <p className="text-slate-300 mb-4">
                   Créer un modèle de machine learning pour prédire les ventes et optimiser la gestion des stocks.
                 </p>
                 <div className="flex justify-between items-center mb-4">
     ...
     {/* 4. ÉCHANTILLONS DE DÉVELOPPEURS */}
     <div className="bg-slate-50 py-24">
       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="grid md:grid-cols-3 gap-8 mb-12">
           {sampleDevelopers.length > 0 ? sampleDevelopers.map((developer, index) => (
             <div key={developer.id} className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-200">
               ...
               <p className="text-slate-600 text-sm mb-4 line-clamp-3">
                 {developer.bio || 'Spécialisé en intelligence artificielle et automatisation, je transforme vos idées en solutions innovantes qui optimisent vos processus métier.'}
               </p>
             ...
             <>
               <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-200">
                 ...
                 <p className="text-slate-600 text-sm mb-4">
                   Spécialiste en IA conversationnelle et automatisation RPA. J'aide les entreprises à optimiser leurs processus grâce à l'intelligence artificielle.
                 </p>
                 <div className="mb-6">
                   <h4 className="text-sm font-semibold text-slate-900 mb-2">Compétences :</h4>
                   <div className="flex flex-wrap gap-2">
               ...
               <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-200">
                 <div className="text-center mb-6">
                   <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4">
                     S
                   </div>
                 ...
                 <p className="text-slate-600 text-sm mb-4">
                   Experte en Machine Learning et Data Science. Je conçois des modèles prédictifs qui transforment vos données en avantage concurrentiel.
                 </p>
                 <div className="mb-6">
                   <h4 className="text-sm font-semibold text-slate-900 mb-2">Compétences :</h4>
                   <div className="flex flex-wrap gap-2">
...
<span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs">TensorFlow</span>
               ...
               <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-slate-200">
                 ...
                 <p className="text-slate-600 text-sm mb-4">
                   Architecte en automatisation et intégration. Je connecte vos systèmes et automatise vos workflows pour une efficacité maximale.
                 </p>
                 <div className="mb-6">
                   <h4 className="text-sm font-semibold text-slate-900 mb-2">Compétences :</h4>
                   <div className="flex flex-wrap gap-2">
