...
export default function ProjectsPage() {
  ...
  const handleCreateProject = () => {
    ...
    // Essayer d'abord avec la route complète
    console.log('Attempting to navigate to create-project');
    try {
      router.push('/dashboard/create-project');
    } catch (error) {
      console.error('Navigation error:', error);
      // Fallback: afficher une alerte
      alert('Redirection vers la création de projet...');
    }
  };
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredProjects.length > 0 ? (
            ...
            /* Section vide avec CTA pour créer un projet */
